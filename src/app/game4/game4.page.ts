...
export class Game4Page implements OnInit {
 ...
 //gameImage:string = "";
  ...
  steamImage:string = "https://cdn.cloudflare.steamstatic.com/steam/apps/736260/header.jpg?t=1656225237";
  steamPrice:string = "12.49";
  ...
  async onDelete(){
    await this.storage.create();
    await this.storage.set("review4", null);
